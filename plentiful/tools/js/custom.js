...
$(document).on('change','#state',function(){
  ...
  if(val!='')
  {
    if(val==1)
    {
        $('#city').html('<option>Select</option><option>Shaymoli</option>');
    }
    else if(val==2)
    {
        $('#city').html('<option>Select</option><option>Bogura</option><option>Rangpur</option>');
    }
    else if(val==3)
    {
        $('#city').html('<option>Select</option><option>CoxBazar</option>');
    }
    else 
    {
