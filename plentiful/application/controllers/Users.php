...
class Users extends CI_Controller
{
	...
	public function manage_user()
	{
		...
		$data['all_users']=$this->cm->select_data('users','*');
	...
	{	
		$resp=$this->cm->delete_data('users',array('id'=>$id));
		redirect(base_url('index.php/users/manage_user'));
	}
	...
	public function edit_product($id)
	{
		if($this->input->method()=='post')
		{
			...
			$this->form_validation->set_rules('subcategory','Area','required');
			$this->form_validation->set_rules('brand','Category','required');
